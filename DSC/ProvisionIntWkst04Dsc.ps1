Configuration SetupIntWkst04
{
    param(
        ...
        # AATP: Used to expose YasminW cred to machine-DEPRECATED
        [Parameter(Mandatory=$true)]
        [ValidateNotNullOrEmpty()]
        [PSCredential]$YasminWCred,        
    ...
    #region AATP stuff
    [PSCredential]$YasminWDomainCred = New-Object System.Management.Automation.PSCredential ("${NetBiosName}\$($YasminWCred.UserName)", $YasminWCred.Password)
    #endregion
    ...
    Node localhost
    {
        ...
        xGroup AddAdmins
        {
            ...
            MembersToInclude = @("$NetBiosName\Helpdesk", "$NetBiosName\YasminW")
            Ensure = 'Present'
        ...
        xRemoteFile DownloadBginfo
		{
			...
			Uri = "https://github.com/Circadence-Corp/DSREexpertBR/raw/$Branch/Downloads/BgInfo/intwkst04.bgi"
            DependsOn = '[Computer]JoinDomain'
		}
        ...
        Registry AutoLogonName
        {
            ...
            ValueType = 'String'
            ValueData =  $YasminWCred.UserName
            Ensure = 'Present'
            DependsOn = '[Computer]JoinDomain'
        }
        ...
        Registry AutoLogonPassword
        {
            ...
            ValueType = 'String'
            ValueData =  $YasminWCred.Password
            Ensure = 'Present'
            DependsOn = '[Computer]JoinDomain'
        }
