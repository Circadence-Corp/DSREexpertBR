Configuration SetupIntWkst15
{
    param(
        ...
        # AATP: Used to expose AngelT cred to machine-DEPRECATED
        [Parameter(Mandatory=$true)]
        [ValidateNotNullOrEmpty()]
        [PSCredential]$AngelTCred,        
    ...
    #region AATP stuff
    [PSCredential]$AngelTDomainCred = New-Object System.Management.Automation.PSCredential ("${NetBiosName}\$($AngelTCred.UserName)", $AngelTCred.Password)
    #endregion
    ...
    Node localhost
    {
        ...
        xGroup AddAdmins
        {
            ...
            MembersToInclude = @("$NetBiosName\Helpdesk", "$NetBiosName\AngelT")
            Ensure = 'Present'
        ...
        xRemoteFile DownloadBginfo
		{
			...
			Uri = "https://github.com/Circadence-Corp/DSREexpertBR/raw/$Branch/Downloads/BgInfo/intwkst15.bgi"
            DependsOn = '[Computer]JoinDomain'
		}
