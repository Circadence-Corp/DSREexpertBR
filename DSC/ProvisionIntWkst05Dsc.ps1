Configuration SetupIntWkst05
{
    param(
        ...
        # AATP: Used to expose StefanM cred to machine-DEPRECATED
        [Parameter(Mandatory=$true)]
        [ValidateNotNullOrEmpty()]
        [PSCredential]$StefanMCred,        
    ...
    #region AATP stuff
    [PSCredential]$StefanMDomainCred = New-Object System.Management.Automation.PSCredential ("${NetBiosName}\$($StefanMCred.UserName)", $StefanMCred.Password)
    #endregion
    ...
    Node localhost
    {
        ...
        xGroup AddAdmins
        {
            ...
            MembersToInclude = @("$NetBiosName\Helpdesk", "$NetBiosName\StefanM")
            Ensure = 'Present'
        ...
        xRemoteFile DownloadBginfo
		{
			...
			Uri = "https://github.com/Circadence-Corp/DSREexpertBR/raw/$Branch/Downloads/BgInfo/intwkst05.bgi"
            DependsOn = '[Computer]JoinDomain'
		}
